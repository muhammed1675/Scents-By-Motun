...
const announcements = [
'Free delivery in Ibadan on orders over ₦100,000',
'Track your order in real time',
"Can't find your scent? We'll source it for you",
'100% authentic — every bottle sealed & verified',
'Small-batch fragrance, blended in Ibadan',
'Nationwide delivery in 2–4 days',
'Experience luxury, support local'];
...
export function Header() {
  ...
  return (
    ...
    <header className="sticky top-0 z-40 bg-ivory/95 backdrop-blur">
      <div className="announcement-banner bg-cocoa py-2">
        <div className="announcement-track">
          ...
          <p aria-hidden="true" className="announcement-scroll text-[11px] uppercase tracking-widest text-ivory">
            {announcements.map((line, i) =>
            <span key={i}>
                {line}
                <span className="mx-4 text-gold">•</span>
        ...
        <div className="container flex items-center justify-between gap-4 py-3.5">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Link
              ...
              className="hidden text-cocoa hover:text-gold sm:block">
        ...
        <div
          ...
          <nav aria-label="Mobile" className="space-y-1">
            ...
            <Link
              to="/admin"
              onClick={() => setMenuOpen(false)}
              className="flex items-center gap-2 border-b border-cocoa/10 py-3 text-sm uppercase tracking-widest text-gold">
